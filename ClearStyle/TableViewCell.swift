...
//        layer.insertSublayer(gradientLayer, atIndex: 0)
        ...
        itemCompleteLayer.backgroundColor = UIColor(red: 0.3, green: 0.6, blue: 0.3,
            alpha: 1.0).CGColor
    ...
    func handlePan(recognizer: UIPanGestureRecognizer) {
        ...
        if recognizer.state == .Changed {
            ...
            tickLabel.textColor = completeOnDragRelease ? UIColor.greenColor() : UIColor.grayColor()
            crossLabel.textColor = deleteOnDragRelease ? UIColor.redColor() : UIColor.grayColor()
        }
        // 3
